...
function GradientText({
  ...
  return (
    <MotionComponent
      className={cn(
        // bg-cream-50 = app dark bg (#0a0a0b) → visually merges with the page.
        // mix-blend-darken bleeds the blob colors onto light text on top of that dark bg.
        "relative inline-flex overflow-hidden bg-cream-50",
        className,
      )}
      {...props}
    >
